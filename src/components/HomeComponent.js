    ...
    return (
        <Row className="d-flex justify-content-center" style={{marginTop: "5vh", marginBottom: "5vh"}}>
                <Col md={4}>
                    ...
                    viewport={{ once: true }}>
                        <CardImg className="pr-3 pl-3" src={baseUrl + details[0].image}/>
                        <h2 className="text-center pt-3">{details[0].header}</h2>
                        <p className="text-center pt-1 pr-2 pl-2">{details[0].description}</p>
                ...
                <Col md={4}>
                    ...
                    whileInView={{x: 0, opacity: 1}}
                    viewport={{ once: true }}>
                        <CardImg className="pr-3 pl-3" src={baseUrl + details[1].image}/>
                        <h2 className="text-center pt-3">{details[1].header}</h2>
                        <p className="text-center pt-1 pr-2 pl-2">{details[1].description}</p>
                        <div className="d-flex justify-content-center home-butt pb-4" onClick={handleClick}>
                            <div className="text-center rounded-0 butt">
                                {details[1].action}
                            </div>
                        </div>
            ...
            <Container style={{maxWidth: "100%", overflow: "hidden", backgroundColor: "rgb(255, 193, 0)"}} className="px-0">
                <RenderCard details={props.home.home.slice(0, 2)}/>
                    ...
                    viewport={{ once: true }}>
                        <Row>
                            <Col md={8}>
                                <CardImg src={baseUrl + props.home.home[2].image}/>
                            </Col>
                            <Col md={4} className="d-flex align-items-center">
                                <div>
                                    <div className="w-100 d-flex justify-content-center">
                                        <motion.svg width="204" height="204" viewBox="-75 0 854 674" fill="none" ref={ref}>
                                    ...
                                    <h2 className="text-center">{props.home.home[2].header}</h2>
                                    <p className="text-center pr-3 pl-3 pt-1">{props.home.home[2].description}</p>
                                    <div className="d-flex justify-content-center home-butt pb-5">
                                        <Link to="/menu">
                                            <div className="text-center rounded-0 butt">
                                                {props.home.home[2].action}
                                            </div>
                                        </Link>
                                    </div>
                                </div>
                        ...
                        <Row>
                            <Col md={4} className="d-flex align-items-center">
                                <div>
                                    ...
                                    <h2 className="text-center">{props.home.home[3].header}</h2>
                                    <p className="text-center pr-3 pl-3 pt-1">{props.home.home[3].description}</p>
                                </div>
                            </Col>
                            <Col md={8}>
                                <CardImg src={baseUrl + props.home.home[3].image}></CardImg>
                            </Col>
                        </Row>
                    </motion.div>
                   </MediaQuery>
